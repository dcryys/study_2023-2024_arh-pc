...
![Программа lab7-4.asm](image/13.png){ #fig:013 width=70%, height=70% }

![Запуск программы lab7-4.asm](image/14.png){ #fig:014 width=70%, height=70% }
...
![Программа lab7-5.asm](image/15.png){ #fig:015 width=70%, height=70% }

![Запуск программы lab7-5.asm](image/16.png){ #fig:016 width=70%, height=70% }
